...
@pytest.mark.network
@pytest.mark.xfail(
    reason="pre-existing, unrelated to tooling migration: live network request to external ranking service",
    strict=False,
)
...
@pytest.mark.network
@pytest.mark.xfail(
    reason="pre-existing, unrelated to tooling migration: external real-world TLD list has drifted", strict=False
)
...
@pytest.mark.xfail(
    reason="pre-existing, unrelated to tooling migration: live DNS lookup; example.com IP has changed", strict=False
)
...
@pytest.mark.xfail(
    reason="pre-existing, unrelated to tooling migration: live WHOIS request; external real-world data has drifted",
    strict=False,
)
